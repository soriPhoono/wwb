...
<template>
  ...
  >
    <div class="p-5 border-b border-gray-200 flex items-center justify-between">
      ...
      <button
        class="bg-transparent text-2xl leading-none text-slate-500 hover:text-slate-800 cursor-pointer border-none"
        @click="toggleCart"
      >
        &times;
      </button>
    ...
    <div id="cart-items" class="p-5 overflow-y-auto flex-1">
      ...
      >
        <div>
          ...
          <p class="m-0 text-blue-600 font-semibold">
    ...
    <div class="p-5 border-t border-gray-200 mt-auto bg-slate-50">
      <h3
        class="m-0 mb-4 flex justify-between text-lg font-bold text-slate-800"
      >
